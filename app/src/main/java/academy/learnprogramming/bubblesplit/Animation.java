...
public class Animation {
    ...
    // Which Sprite row of the image we are currently
    ...
    // in which Sprite we are.. and a timer
     */
    ...
    public void update() {
        /**
         * timer determines which Sprite of the image is going be return every time
